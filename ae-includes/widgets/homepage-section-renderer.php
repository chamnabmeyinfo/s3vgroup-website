...
function buildSectionStyles($styles) {
    ...
    if (!empty($styles['background_image'])) {
        $styleArray[] = 'background-image: url(' . htmlspecialchars(fullImageUrl($styles['background_image']), ENT_QUOTES) . ')';
...
function renderHeroSection($title, $content, $styles, $primaryColor, $secondaryColor, $accentColor) {
    ...
    $backgroundStyle = '';
    if ($bgImage) {
        $backgroundStyle = "background-image: url('" . htmlspecialchars(fullImageUrl($bgImage), ENT_QUOTES) . "'); background-size: cover; background-position: center;";
                       ...
                       data-animation="fadeInUp">
                        <?php if ($product['heroImage']): ?>
                            <div class="product-card-image-wrapper">
                                <img src="<?php echo e(fullImageUrl($product['heroImage'])); ?>" 
...
function renderNewsletterSection($title, $content, $styles, $primaryColor, $secondaryColor) {
    ...
    $backgroundStyle = '';
    if (!empty($styles['background_image'])) {
        $backgroundStyle = "background-image: url('" . htmlspecialchars(fullImageUrl($styles['background_image']), ENT_QUOTES) . "'); background-size: cover; background-position: center;";
    } elseif (!empty($styles['background_color'])) {
        $backgroundStyle = 'background-color: ' . htmlspecialchars($styles['background_color'], ENT_QUOTES) . ';';
    } else {
