...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            <form id="config-form" class="space-y-4">
                ...
                <button type="submit" class="w-full px-4 py-2 bg-[#0b3a63] text-white rounded-md hover:bg-[#1a5a8a] transition-colors font-semibold">
                    Save Configuration
                </button>
            </form>
        </div>
    ...
    <div class="mt-6 bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">Database Operations</h2>
        <p class="text-sm text-gray-600 mb-6">Export from local or import to cPanel</p>
